...
class User {
  ...
  User({required this.id, required this.name, required this.username, required this.avatar});
}
...
final List<User> mockFollowingUsers = [
  User(id: 1, name: 'Sarah Chen', username: '@sarahchen', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah'),
  User(id: 2, name: 'Alex Rivera', username: '@alexrivera', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Alex'),
  User(id: 3, name: 'Maya Patel', username: '@mayapatel', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Maya'),
  User(id: 4, name: 'David Kim', username: '@davidkim', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=David'),
  User(id: 5, name: 'Emma Wilson', username: '@emmawilson', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Emma'),
  User(id: 6, name: 'James Anderson', username: '@jamesanderson', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=James'),
  User(id: 7, name: 'Lisa Park', username: '@lisapark', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Lisa'),
  User(id: 8, name: 'Nina Rodriguez', username: '@ninarodriguez', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Nina'),
];
...
final List<Post> mockPosts = [
  ...
  Post(
    ...
    content: 'Just tried the new coffee shop downtown. Their latte art is on point! ☕️',
  ...
  Post(
    ...
    content: 'Thinking about switching from VS Code to Zed. Has anyone tried it extensively for Python development? 🤔',
  ...
  Post(
    ...
    content: 'Designing a new logo for a client. Minimalist style is always challenging but rewarding. ✏️',
  ...
  Post(
    ...
    content: 'AI is evolving so fast! It\'s hard to keep up with all the new papers coming out every week. 🤖',
  ...
  Post(
    ...
    content: 'Does anyone have recommendations for good sci-fi movies on Netflix right now? 🍿',
...
final List<Article> mockArticles = [
  Article(
    ...
    coverImage: 'https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?w=800&auto=format',
    readTime: '5 min read',
    likes: 1256,
    comments: 89,
    tags: ['早餐', '食谱', '健康'],
  ...
  Article(
    ...
    coverImage: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&auto=format',
    readTime: '8 min read',
    likes: 2341,
    comments: 156,
    tags: ['收纳', '家居', '整理'],
  ...
  Article(
    ...
    coverImage: 'https://images.unsplash.com/photo-1527631746610-bca00a040d60?w=800&auto=format',
  ...
  Article(
    ...
    coverImage: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=800&auto=format',
    readTime: '7 min read',
    likes: 1890,
    comments: 145,
    tags: ['护肤', '美容', '保养'],
  ...
  Article(
    ...
    coverImage: 'https://images.unsplash.com/photo-1517842645767-c639042777db?w=800&auto=format',
...
final Map<int, List<Story>> mockStories = {
  1: [ // Sarah Chen
    Story(
      id: 's1-1',
      imageUrl: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800&auto=format',
      timestamp: DateTime.now().subtract(const Duration(hours: 2)),
    ),
    Story(
      id: 's1-2',
      imageUrl: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=800&auto=format',
  ...
  2: [ // Alex Rivera
    Story(
      id: 's2-1',
      imageUrl: 'https://images.unsplash.com/photo-1492633423870-43d1cd2775eb?w=800&auto=format',
      timestamp: DateTime.now().subtract(const Duration(hours: 4)),
    ),
  ],
  3: [ // Maya Patel
    Story(
      id: 's3-1',
      imageUrl: 'https://images.unsplash.com/photo-1517404215738-15263e9f9178?w=800&auto=format',
      timestamp: DateTime.now().subtract(const Duration(hours: 6)),
    ),
  ],
  4: [ // David Kim
     Story(
      id: 's4-1',
      imageUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=800&auto=format',
