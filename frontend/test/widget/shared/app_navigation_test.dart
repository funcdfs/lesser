...
void main() {
  ...
  group('AppNavBar Rendering', () {
    testWidgets('renders nav bar with title', (tester) async {
      await tester.pumpWidget(createTestWidget(AppNavBar(title: 'Page Title')));
    ...
    testWidgets('renders nav bar using simple factory', (tester) async {
      await tester.pumpWidget(
        createTestWidget(AppNavBar.simple(title: 'Simple Title')),
      );

      expect(find.text('Simple Title'), findsOneWidget);
    });

    testWidgets('renders nav bar with back button when onBack provided', (
      tester,
    ) async {
      bool backPressed = false;
      await tester.pumpWidget(
        createTestWidget(
          AppNavBar(title: 'With Back', onBack: () => backPressed = true),
        ),
      );
    ...
    testWidgets('does not show back button when onBack is null', (
      ...
      await tester.pumpWidget(
        createTestWidget(AppNavBar(title: 'No Back', onBack: null)),
      );
    ...
    testWidgets('renders nav bar with custom back icon', (tester) async {
      await tester.pumpWidget(
        createTestWidget(
          AppNavBar(title: 'Custom Back', onBack: () {}, backIcon: Icons.close),
        ),
      );
      ...
      await tester.pumpWidget(
        createTestWidget(
          AppNavBar(
            title: 'With Actions',
            actions: [
              AppNavBarAction(icon: Icons.search, onPressed: () {}),
              AppNavBarAction(icon: Icons.more_vert, onPressed: () {}),
            ],
          ),
        ),
      );
    ...
    testWidgets('renders transparent nav bar', (tester) async {
      await tester.pumpWidget(
        createTestWidget(
          AppNavBar.transparent(title: 'Transparent', onBack: () {}),
        ),
      );
  ...
  group('AppBottomNavBar Navigation Switching', () {
    ...
    testWidgets('updates selected state when currentIndex changes', (
      tester,
    ) async {
      int currentIndex = 0;
    ...
    testWidgets('renders bottom nav without labels when showLabels is false', (
      tester,
    ) async {
      await tester.pumpWidget(
        createTestWidget(
