...
// SettingsDataAccess 用户设置数据访问
type SettingsDataAccess struct {
	db *sql.DB
}

// NewSettingsDataAccess 创建设置数据访问实例
func NewSettingsDataAccess(db *sql.DB) *SettingsDataAccess {
	return &SettingsDataAccess{db: db}
}
...
func (r *SettingsDataAccess) GetPrivacySettings(ctx context.Context, userID string) (*PrivacySettings, error) {
...
func (r *SettingsDataAccess) UpsertPrivacySettings(ctx context.Context, settings *PrivacySettings) error {
	now := time.Now()
...
func (r *SettingsDataAccess) UpdatePrivacySettings(ctx context.Context, userID string, updates map[string]interface{}) error {
...
func (r *SettingsDataAccess) GetNotificationSettings(ctx context.Context, userID string) (*NotificationSettings, error) {
...
func (r *SettingsDataAccess) UpsertNotificationSettings(ctx context.Context, settings *NotificationSettings) error {
	now := time.Now()
	_, err := r.db.ExecContext(ctx, `
...
func (r *SettingsDataAccess) UpdateNotificationSettings(ctx context.Context, userID string, updates map[string]interface{}) error {
...
func (r *SettingsDataAccess) GetUserSettings(ctx context.Context, userID string) (*UserSettings, error) {
...
func (r *SettingsDataAccess) InitializeUserSettings(ctx context.Context, userID string) error {
...
func (r *SettingsDataAccess) IsPrivateAccount(ctx context.Context, userID string) (bool, error) {
	var isPrivate bool
	err := r.db.QueryRowContext(ctx, `
		SELECT COALESCE(
