...
func TestCreate_ShortContent_EmptyText(t *testing.T) {
	...
	err := svc.validateContent(repository.ContentTypeShort, "", "", false)
...
func TestCreate_ArticleContent_ValidContent(t *testing.T) {
	...
	err := svc.validateContent(repository.ContentTypeArticle, "标题", "正文内容", false)
	if err != nil {
...
func TestCreate_ArticleContent_MissingTitle(t *testing.T) {
	...
	err := svc.validateContent(repository.ContentTypeArticle, "", "正文内容", false)
...
func TestCreate_ArticleContent_MissingText(t *testing.T) {
	...
	err := svc.validateContent(repository.ContentTypeArticle, "标题", "", false)
	if err != ErrTextRequired {
		t.Errorf("期望 ErrTextRequired 错误，但得到: %v", err)
	}
}
...
func TestCreate_ArticleContent_DraftAllowsEmpty(t *testing.T) {
	...
	err := svc.validateContent(repository.ContentTypeArticle, "", "", true)
	if err != nil {
...
func TestCreate_ArticleContent_ExceedsMaxLength(t *testing.T) {
	...
	err := svc.validateContent(repository.ContentTypeArticle, "标题", text, false)
	if err != ErrContentTooLong {
		t.Errorf("期望 ErrContentTooLong 错误，但得到: %v", err)
	}
}
...
func TestCreate_StoryContent_ValidContent(t *testing.T) {
	...
	err := svc.validateContent(repository.ContentTypeStory, "", "Story 内容", false)
	if err != nil {
...
func TestCreate_StoryContent_ExceedsMaxLength(t *testing.T) {
	...
	err := svc.validateContent(repository.ContentTypeStory, "", text, false)
	if err != ErrContentTooLong {
		t.Errorf("期望 ErrContentTooLong 错误，但得到: %v", err)
	}
}
...
func TestCreate_StoryContent_EmptyText(t *testing.T) {
	...
	err := svc.validateContent(repository.ContentTypeStory, "", "", false)
	if err != ErrTextRequired {
		t.Errorf("期望 ErrTextRequired 错误，但得到: %v", err)
	}
}
...
func TestContentTypes(t *testing.T) {
	// 验证内容类型常量
	if repository.ContentTypeUnspecified != 0 {
		t.Error("ContentTypeUnspecified 应该为 0")
	}
	if repository.ContentTypeStory != 1 {
		t.Error("ContentTypeStory 应该为 1")
	}
	if repository.ContentTypeShort != 2 {
		t.Error("ContentTypeShort 应该为 2")
	}
	if repository.ContentTypeArticle != 3 {
...
func TestContentStatus(t *testing.T) {
	// 验证内容状态常量
	if repository.ContentStatusUnspecified != 0 {
		t.Error("ContentStatusUnspecified 应该为 0")
	}
	if repository.ContentStatusDraft != 1 {
		t.Error("ContentStatusDraft 应该为 1")
	}
	if repository.ContentStatusPublished != 2 {
		t.Error("ContentStatusPublished 应该为 2")
	}
	if repository.ContentStatusArchived != 3 {
		t.Error("ContentStatusArchived 应该为 3")
	}
	if repository.ContentStatusDeleted != 4 {
...
func TestCounterTypes(t *testing.T) {
	// 验证计数器类型常量
	if repository.CounterTypeUnspecified != 0 {
		t.Error("CounterTypeUnspecified 应该为 0")
	}
	if repository.CounterTypeLike != 1 {
		t.Error("CounterTypeLike 应该为 1")
	}
	if repository.CounterTypeComment != 2 {
		t.Error("CounterTypeComment 应该为 2")
	}
	if repository.CounterTypeRepost != 3 {
		t.Error("CounterTypeRepost 应该为 3")
	}
	if repository.CounterTypeBookmark != 4 {
...
func TestDraftNotAllowed_ForShort(t *testing.T) {
	...
	contentType := repository.ContentTypeShort
...
func TestDraftNotAllowed_ForStory(t *testing.T) {
	// 测试 Story 类型不支持草稿
	contentType := repository.ContentTypeStory
	if contentType == repository.ContentTypeArticle {
...
func TestDraftAllowed_ForArticle(t *testing.T) {
	// 测试 Article 类型支持草稿
	contentType := repository.ContentTypeArticle
	if contentType != repository.ContentTypeArticle {
...
func TestValidateContent_ExactMaxLength(t *testing.T) {
	...
	tests := []struct {
		...
		{"Short 280 字符", repository.ContentTypeShort, ShortMaxLength},
		{"Story 500 字符", repository.ContentTypeStory, StoryMaxLength},
	}
...
func TestValidateContent_OneOverMaxLength(t *testing.T) {
	...
	tests := []struct {
		...
		{"Short 281 字符", repository.ContentTypeShort, ShortMaxLength},
		{"Story 501 字符", repository.ContentTypeStory, StoryMaxLength},
	}
