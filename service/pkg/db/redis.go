...
// SetString 存储字符串值
func (c *RedisClient) SetString(ctx context.Context, key, value string, expiration time.Duration) error {
...
func (c *RedisClient) PublishString(ctx context.Context, channel, message string) error {
...
// ExpireAt 设置过期时间点
func (c *RedisClient) ExpireAt(ctx context.Context, key string, tm time.Time) (bool, error) {
...
// Persist 移除过期时间
func (c *RedisClient) Persist(ctx context.Context, key string) (bool, error) {
