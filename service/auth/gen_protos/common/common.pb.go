...
type Pagination struct {
	...
	Total         int32                  `protobuf:"varint,3,opt,name=total,proto3" json:"total,omitempty"`                       // 总数（响应时填充）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Timestamp struct {
	...
	Nanos         int32                  `protobuf:"varint,2,opt,name=nanos,proto3" json:"nanos,omitempty"`     // 纳秒部分
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ErrorDetail struct {
	...
	Metadata      map[string]string      `protobuf:"bytes,3,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 附加信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type HealthCheckRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Service       string                 `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"` // 服务名称，空表示检查整体健康
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_common_common_proto_rawDesc = "" +
	...
	"\x05nanos\x18\x02 \x01(\x05R\x05nanos\"\xb7\x01\n" +
...
var file_common_common_proto_goTypes = []any{
	...
	nil,                                    // 7: common.ErrorDetail.MetadataEntry
}
var file_common_common_proto_depIdxs = []int32{
	7, // 0: common.ErrorDetail.metadata:type_name -> common.ErrorDetail.MetadataEntry
	0, // 1: common.HealthCheckResponse.status:type_name -> common.HealthCheckResponse.ServingStatus
	5, // 2: common.HealthService.Check:input_type -> common.HealthCheckRequest
	5, // 3: common.HealthService.Watch:input_type -> common.HealthCheckRequest
	6, // 4: common.HealthService.Check:output_type -> common.HealthCheckResponse
	6, // 5: common.HealthService.Watch:output_type -> common.HealthCheckResponse
