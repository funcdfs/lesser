// Package data_access 用户管理 PostgreSQL 仓库实现
package data_access
...
// UserRepositoryImpl PostgreSQL 用户仓库（用于管理普通用户）
...
// List 获取用户列表
func (r *UserRepositoryImpl) List(ctx context.Context, filter UserFilter) ([]*User, int, error) {
	// 构建查询条件
...
// Ban 封禁用户
func (r *UserRepositoryImpl) Ban(ctx context.Context, id uuid.UUID, reason string, expiresAt *time.Time, operatorID uuid.UUID) error {
	// 先取消之前的封禁记录
...
// Unban 解封用户
func (r *UserRepositoryImpl) Unban(ctx context.Context, id uuid.UUID) error {
