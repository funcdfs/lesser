...
// Create 创建审计日志
func (r *AuditLogRepository) Create(ctx context.Context, log *data_access.AuditLog) error {
	query := `
...
// List 获取审计日志列表
func (r *AuditLogRepository) List(ctx context.Context, filter data_access.AuditLogFilter) ([]*data_access.AuditLog, int, error) {
	// 构建查询条件
