// Package data_access 会话 PostgreSQL 数据访问实现
package data_access
...
// SessionDataAccessImpl PostgreSQL 会话数据访问
type SessionDataAccessImpl struct {
	db *sql.DB
}

// NewSessionDataAccess 创建会话数据访问
func NewSessionDataAccess(db *sql.DB) *SessionDataAccessImpl {
	return &SessionDataAccessImpl{db: db}
}

// Create 创建会话
func (r *SessionDataAccessImpl) Create(ctx context.Context, session *Session) error {
	query := `
...
func (r *SessionDataAccessImpl) GetByTokenHash(ctx context.Context, tokenHash string) (*Session, error) {
	query := `
...
// Revoke 撤销会话
func (r *SessionDataAccessImpl) Revoke(ctx context.Context, tokenHash string) error {
...
func (r *SessionDataAccessImpl) RevokeAllByUserID(ctx context.Context, userID uuid.UUID) error {
...
// CleanExpired 清理过期会话
func (r *SessionDataAccessImpl) CleanExpired(ctx context.Context) error {
...
// 确保实现接口
var _ SessionDataAccess = (*SessionDataAccessImpl)(nil)
