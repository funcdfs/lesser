...
import (
	common "github.com/lesser/auth_worker/proto/common"
...
// AuthResponse returned after successful auth operations
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\tR\x06userId2\xca\x02\n" +
	"\vAuthService\x125\n" +
	...
	".auth.UserB*Z(github.com/lesser/auth_worker/proto/authb\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	9,  // 0: auth.User.created_at:type_name -> common.Timestamp
	...
	6,  // 6: auth.AuthService.ValidateToken:input_type -> auth.ValidateRequest
	...
	10, // 10: auth.AuthService.Logout:output_type -> common.Empty
	3,  // 11: auth.AuthService.RefreshToken:output_type -> auth.AuthResponse
	7,  // 12: auth.AuthService.ValidateToken:output_type -> auth.ValidateResponse
	0,  // 13: auth.AuthService.GetUser:output_type -> auth.User
