...
class HealthResponse extends $pb.GeneratedMessage {
  factory HealthResponse({
    $core.bool? healthy,
    $core.Iterable<$core.MapEntry<$core.String, ServiceStatus>>? services,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, ServiceStatus>(2, _omitFieldNames ? '' : 'services',
        entryClassName: 'HealthResponse.ServicesEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: ServiceStatus.create,
        valueDefaultOrMaker: ServiceStatus.getDefault,
        packageName: const $pb.PackageName('gateway'))
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $pb.PbMap<$core.String, ServiceStatus> get services => $_getMap(1);
}
