...
class SeriesPostModel {
  ...
  SeriesPostModel withReactionAdded(String emoji) => copyWith(
  ...
  SeriesPostModel withReactionRemoved() {
  ...
  SeriesPostModel withReactionToggled(String emoji) {
    if (myReaction == emoji) {
  ...
  /// 评论数 +1（乐观更新）
  SeriesPostModel withCommentAdded() =>
  ...
  bool operator ==(Object other) =>
      ...
      (other is SeriesPostModel && id == other.id);
  ...
  String toString() {
    final preview = content.length > 20
        ...
        : content;
    return 'SeriesPostModel(id: $id, content: $preview)';
  }
}
