...
import '../widgets/series_tag_drawer.dart';
...
class _SeriesPageState extends State<SeriesPage> {
  ...
  void _onSeriesTap(SeriesModel series) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // 使用统一的 SeriesTagDrawer 组件，标签数据从 mock_data 获取
          SeriesTagDrawer(
            tags: mockSeriesTags,
  ...
  Widget _buildContent(AppColorScheme colors) {
    ...
    if (_handler.seriesList.isEmpty) {
      return const _EmptyView();
    }

    var seriesList = _handler.seriesList;
...
/// 列表项使用 SeriesItem 组件，传入 UI 状态用于显示未读数等。
class _SeriesListView extends StatelessWidget {
  ...
  final SeriesUIState? Function(String seriesId) getUIState;
  final Future<void> Function() onRefresh;
  final void Function(SeriesModel) onSeriesTap;
