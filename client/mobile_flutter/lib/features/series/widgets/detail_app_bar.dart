  ...
  Widget build(BuildContext context) {
    ...
    return FrostedAppBar(
      ...
      title: seriesData == null
          ? null
          : _SeriesTitle(series: seriesData, seriesId: seriesId),
      actions: [
        IconButton(
          key: moreButtonKey,
...
class _SeriesTitle extends StatelessWidget {
  const _SeriesTitle({required this.series, required this.seriesId});
