...
class PostListController {
  ...
  /// 更新缓存
  void updateCache(List<SeriesPostModel> posts) {
  ...
  /// 构建列表项（动态 + 日期分隔符）
  List<ListItem> _buildListItems(List<SeriesPostModel> posts) {
...
class HighlightController {
  ...
  void _scrollToIndexAndHighlight(int index, String postId) {
    ...
    if (keyContext != null) {
      ...
      final targetOffset = index * SeriesLayoutConstants.estimatedItemHeight;
