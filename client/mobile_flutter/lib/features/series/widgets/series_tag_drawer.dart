...
class SeriesTagDrawer extends StatefulWidget {
  const SeriesTagDrawer({
    super.key,
    required this.tags,
  ...
  final void Function(SeriesTag tag) onTagTap;

  @override
  State<SeriesTagDrawer> createState() => _SeriesTagDrawerState();
}

class _SeriesTagDrawerState extends State<SeriesTagDrawer> {
  // -------------------------------------------------------------------------
  // 状态变量
  // -------------------------------------------------------------------------
