...
///   与评论入口连接时为 false
class SeriesPostBubble extends StatelessWidget {
  const SeriesPostBubble({
    super.key,
    required this.post,
    this.onTap,
    this.onLinkTap,
...
class SeriesPost extends StatefulWidget {
  const SeriesPost({
    super.key,
    required this.post,
    this.onTap,
  ...
  /// 菜单操作回调
  final void Function(SeriesPostMenuAction action)? onMenuAction;
  ...
  @override
  State<SeriesPost> createState() => _SeriesPostState();
}

class _SeriesPostState extends State<SeriesPost> {
  ...
  static const _menuActionMap = {
    'save': SeriesPostMenuAction.save,
    'forward': SeriesPostMenuAction.forward,
    'detail': SeriesPostMenuAction.detail,
  };
  ...
  void _handleMenuSelection(String value) {
    final action = _menuActionMap[value] ?? SeriesPostMenuAction.detail;
