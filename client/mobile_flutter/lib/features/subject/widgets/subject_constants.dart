...
// =============================================================================
//
// 集中定义剧集模块的布局常量，确保 UI 一致性并便于统一调整。
//
// ## 设计原则
//
...
// ## 常量类列表
//
// - `SubjectLayoutConstants` - 通用布局常量
// - `SubjectItemLayout` - 剧集列表项布局
...
///
/// 定义动态列表、滚动行为等通用参数。
abstract final class SubjectLayoutConstants {
  /// 动态气泡最大宽度比例（相对于屏幕宽度）
  ///
...
/// 剧集列表项布局常量
///
/// 定义剧集列表项的内边距、头像大小、间距等参数。
abstract final class SubjectItemLayout {
  /// 列表项内边距
