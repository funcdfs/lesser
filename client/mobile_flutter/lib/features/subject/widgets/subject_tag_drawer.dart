// =============================================================================
// 剧集标签抽屉组件 - Series Tag Drawer Widget
// =============================================================================
//
// ## 设计目的
// 提供底部可拖拽展开/收起的标签选择器，用于剧集列表页的标签筛选功能。
...
/// 剧集标签抽屉
///
/// 底部可拖拽展开/收起的标签选择器，用于剧集列表页的标签筛选。
///
/// ## 参数说明
/// - [tags]: 可选标签列表
/// - [selectedTags]: 当前选中的标签 ID 集合
/// - [onTagTap]: 标签点击回调，由父组件处理选中状态切换
class SubjectTagDrawer extends StatefulWidget {
  const SubjectTagDrawer({
    super.key,
    required this.tags,
  ...
  final void Function(SubjectTag tag) onTagTap;

  @override
  State<SubjectTagDrawer> createState() => _SubjectTagDrawerState();
}

class _SubjectTagDrawerState extends State<SubjectTagDrawer> {
  // -------------------------------------------------------------------------
  // 状态变量
  // -------------------------------------------------------------------------
