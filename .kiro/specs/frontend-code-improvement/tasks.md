...
- [x] 1. Phase 1: 代码质量修复（高优先级）

- [x] 1.1 修复 Riverpod API 弃用警告
...
- [x] 1.2 修复 Freezed 模型 JsonKey 注解警告
...
- [x] 2.5 Checkpoint - 确保基础设施测试通过
  - 运行所有测试确认通过
  - 确保所有测试通过，如有问题请询问用户


- [x] 3. Phase 3: Auth 模块完善
...
- [x] 3.5 Checkpoint - 确保 Auth 功能正常
  - 测试登录流程
  - 测试注册流程
  - 测试登出流程
  - 确保所有测试通过，如有问题请询问用户

- [x] 4. Phase 4: Feeds 模块完善
...
- [x] 4.6 Checkpoint - 确保 Feeds 功能正常
  - 确保所有测试通过，如有问题请询问用户


- [x] 5. Phase 5: Search 模块实现
...
- [x] 5.7 Checkpoint - 确保 Search 功能正常
  - 确保所有测试通过，如有问题请询问用户

- [x] 6. Phase 6: Settings 模块完善
...
- [x] 6.7 Checkpoint - 确保 Settings 功能正常
  - 测试主题切换
  - 测试设置持久化
  - 确保所有测试通过，如有问题请询问用户


- [x] 7. Phase 7: Create 模块完善
...
- [x] 7.6 Checkpoint - 确保 Create 功能正常
  - 测试内容验证
  - 测试草稿保存和加载
  - 确保所有测试通过，如有问题请询问用户

- [x] 8. Phase 8: Chat 模块实现（可选）
